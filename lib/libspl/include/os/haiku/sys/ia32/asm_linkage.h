/*
 * HAIKU PORTING NOTES:
 * - straight copy of freebsd, no notes. if it works, great, if it
 *   doesn't, maybe I just drop all the assembly and run the scalar versions
 *   for the moment. zalgo forever.
 */
