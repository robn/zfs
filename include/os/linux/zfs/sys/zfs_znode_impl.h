...
#define	ZTOZSB(znode)	(((vfs_bind_t *)(ZTOI(znode)->i_sb->s_fs_info))->vb_zfsvfs)
#define	ITOZSB(inode)	(((vfs_bind_t *)((inode)->i_sb->s_fs_info))->vb_zfsvfs)
#define	DTOZSB(dentry)	(((vfs_bind_t *)((dentry)->d_sb->s_fs_info))->vb_zfsvfs)
